...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="loginbox radius">
        <div class="loginboxinner">
            ...
            <asp:TextBox ID="name" runat="server" Width="332px" required="required"></asp:TextBox><br />
            <asp:Label runat="server">Email</asp:Label><br />
            <asp:TextBox ID="email" runat="server" Width="332px" TextMode="Email" required="required"></asp:TextBox><br />
            <asp:Label runat="server">Login</asp:Label><br />
            <asp:TextBox ID="login" runat="server" Width="332px" required="required"></asp:TextBox><br />
            <asp:RadioButtonList ID="RadioButtonList1" runat="server" Height="16px" Width="428px" required="required">
            ...
            <asp:TextBox ID="reason" runat="server" Width="471px" Height="24px" TextMode="MultiLine" required="required"></asp:TextBox><br />
            <asp:Label for="DateNeeded" runat="server" Text="Date Needed"></asp:Label><br />
            <asp:TextBox ID="DateNeeded" runat="server" TextMode="Date" required="required"></asp:TextBox><br />
